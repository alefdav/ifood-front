    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">iFood Perfeito</h3>
            <p className="text-gray-300">
              Otimize seu cardápio e aumente suas vendas no iFood com análises e recomendações personalizadas.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-center">
                ...
                <span>contato@ifoodperfeito.com.br</span>
              </li>
              <li className="flex items-center">
                <svg className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center text-gray-300">
          <p>&copy; {currentYear} iFood Perfeito. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
